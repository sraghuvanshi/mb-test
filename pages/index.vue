  ...
  <div>
    <header id="home">
      <!-- <div class="header_text">
        <p>
          <a id="header_button" href="#intro">KNOW MORE</a>
        </p>
      </div>-->
    </header>
